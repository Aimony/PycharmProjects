...
#
#     # 初始化函数
#     def game_initializaion(score, money, world, time, Gdata, TimersSec, Timers, x, y, inp_flag, times, times2,
#                            move_values, jump_values, jump_values2, jump_values3, jump_adder, jump_max_point, jump_flag,
#                            bg_w_1, bg_w_2, tim_psd):  # 数据初始化
#
#     # 游戏初始化数据
#     inp_flag = -2  # (stop:-1 left drection ,-2 right drection) ,(walk:1 right drection ,2 left drection)
...
#                            move_values, jump_values, jump_values2, jump_values3, jump_adder, jump_max_point, jump_flag,
#                            bg_w_1, bg_w_2, tim_psd)  # 数据初始化主调函数
#
...
#             game_initializaion(score, money, world, time, Gdata, TimersSec, Timers, x, y, inp_flag, times, times2, \
#                                move_values, jump_values, jump_values2, jump_values3, jump_adder, jump_max_point,
#                                jump_flag, bg_w_1, \
#                                bg_w_2, tim_psd)
#
#     if event.type == KEYUP:
...
#     elif DATAi == 2:
#         Game_data = mariofont.render("%s-%s" % (Gdata[DATAi] / 10, Gdata[DATAi] % 10), True, (255, 255, 128),
#                                      None)  # 综合绘制: 分数 金币 关卡 游戏时间
